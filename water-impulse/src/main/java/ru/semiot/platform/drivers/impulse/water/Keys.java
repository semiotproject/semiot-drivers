...
public abstract class Keys extends DeviceProperties{
  ...
  public static final String DRIVER_PID = "ru.semiot.platform.drivers.impulse.water";
  ...
  public static final String OBSERVATION_VALUE = "ru.semiot.platform.drivers.impulse.water.observation.value";
  public static final String OBSERVATION_TYPE = "ru.semiot.platform.drivers.impulse.water.observation.type";
